Pod::Spec.new do |spec|
  spec.name = "wechatOpenSDK_jarhom"
  spec.version = "1.9.2"
  ...
  spec.homepage = "https://blog.jarhom.com/"
  spec.license = "MIT"
  spec.author = { "run" => "332139705@qq.com" }
  spec.source = { :git => "https://github.com/JarhomChen/wechatOpenSDK.git", :tag => "#{spec.version}" }
